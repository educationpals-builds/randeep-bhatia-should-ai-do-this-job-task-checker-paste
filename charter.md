...
## Spec
The pinned ask, requester, stakes, deadline, the text-in/text-out restatement, five dial scores with notes, verdict, flip condition, reshape — the builder's full run.
