...
## Spec
The builder's first-person story: what they built, the probe that fooled it (quoted from the board), the fix, the gate it now holds, the re-cert cadence, the domain lesson. Cites only board/gate/provenance; at least one named failure mandatory. Renders as the marketplace card's story.
