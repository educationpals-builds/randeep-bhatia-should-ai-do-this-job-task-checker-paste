# blueprints/task-checker.md

> "Should AI do this job?" task checker — paste any task someone wants handed to a model, get a fit read

## Spec
One-paste spec: system instructions for the five-dial conversational task checker, with - **__desk_reached_compile**: true
...
- **who_wants_it**: The lab PI, who is drowning in the feed and already announced the triage bot at last week's all-hands as calibration.
