# skills/task-advisor.skill.md

> "Should AI do this job?" task checker — paste any task someone wants handed to a model, get a fit read

## Spec
The advisor as a portable skill file: stream, stance with refusal, dial instructions, output shape — loadable into any assistant runtime.
